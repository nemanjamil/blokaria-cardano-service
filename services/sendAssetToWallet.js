...
router.post('/', async (req, res) => {
	...
	let spreadTxInfo = {...txInfo}

	spreadTxInfo.txOut[0].value.lovelace -= fee

	console.log(JSON.stringify(spreadTxInfo, null, 4));

        const tx = cardano.transactionBuildRaw({ ...spreadTxInfo, fee })
